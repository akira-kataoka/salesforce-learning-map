...
Trailhead「Service Cloud」、Service Cloud Consultant試験ガイド`,
  ...
  { id:'prod-marketing-cloud', label:'Marketing Cloud', type:'product', category:'cloud',
    summary:'B2C向けのデジタルマーケ基盤。メール・ジャーニー・マルチチャネルを自動化。',
    tags:['marketing','automation','email','b2c'],
    detail:`## 概要
主にB2C向けのデジタルマーケティングプラットフォーム(Marketing Cloud Engagement)。Email Studio・Journey Builder・Automation Studio・Mobile Studio・Data Extension を中核に、大規模なパーソナライズ配信を行う。
## なぜ学ぶのか
メール・SMS・プッシュを横断したジャーニーを自動化でき、専門職(マーケター)としてのキャリアが確立している。B2Bの Account Engagement とは別製品なので注意。
## 主要トピック
- Email Studio・Journey Builder・Automation Studio
- AMPscript・データエクステンション・Contact Builder
## おすすめリソース
Trailhead「Marketing Cloud」、各Specialist試験ガイド`,
    links:[{to:'concept-automation',rel:'活用'},{to:'concept-data-management',rel:'活用'},{to:'role-marketer',rel:'対象職種'}] },

  { id:'prod-account-engagement', label:'Account Engagement (旧Pardot)', type:'product', category:'cloud',
    summary:'B2B向けマーケ自動化(旧Pardot)。スコアリングとナーチャリングが中核。',
    tags:['marketing','pardot','b2b'],
    detail:`## 概要
主にB2B向けのマーケティングオートメーション(旧Pardot)。プロスペクト管理・スコアリング/グレーディング・エンゲージメントスタジオでリード育成を自動化し、Sales Cloud と密に連携する。
## なぜ学ぶのか
B2Bの長い検討期間に寄り添うナーチャリング設計ができる。Marketing Cloud(B2C)とは基盤もUIも異なる別製品。
## 主要トピック
- プロスペクト・スコアリング/グレーディング
- エンゲージメントスタジオ・フォーム/LP・B2Bマーケティングアナリティクス
## おすすめリソース
Trailhead「Account Engagement」、Account Engagement Specialist/Consultant試験ガイド`,
    links:[{to:'concept-automation',rel:'活用'},{to:'prod-sales-cloud',rel:'連携'},{to:'role-marketer',rel:'対象職種'}] },
...
Trailhead「Data Cloud」、Data Cloud Consultant試験ガイド`,
  ...
  { id:'prod-agentforce', label:'Agentforce', type:'product', category:'ai',
    summary:'自律的にタスクを遂行するAIエージェント基盤(生成AI・Agent/Prompt Builder)。',
    tags:['ai','agentforce'],
    detail:`## 概要
自律的に業務を遂行するAIエージェントのプラットフォーム。Agent Builder・Prompt Builder・Einstein Copilot・Trust Layer で構成され、良質な統合データ(Data Cloud)を土台に動く。
## なぜ学ぶのか
2024年以降の最重要トレンド。予測AIの Einstein とは別レイヤーの製品で、Agent/Prompt Builder のスキルは今後の管理者・開発者に必須化していく。
## 主要トピック
- Agentforce(自律型エージェント)・Agent Builder
- Prompt Builder・Einstein Copilot・Trust Layer
## おすすめリソース
Trailhead「Agentforce」、Agentforce Specialist試験ガイド`,
    links:[{to:'concept-ai',rel:'中核'},{to:'prod-data-cloud',rel:'依存'},{to:'prod-einstein',rel:'土台'},{to:'concept-security',rel:'Trust Layer'}] },

  { id:'prod-einstein', label:'Einstein', type:'product', category:'ai',
    summary:'予測AI・生成AIのレイヤー。スコアリング・予測・レコメンド・ボット。',
    tags:['ai','einstein'],
    detail:`## 概要
CRMに組み込まれた予測AI・生成AIの機能群。Einstein予測(Prediction Builder)・Next Best Action・Einstein Bots・各クラウド特化AI(Sales/Service)を提供する。Agentforce(自律エージェント)の土台にもなる。
## なぜ学ぶのか
生成AIブーム以前からの予測AIの中核で、AI資格(AI Associate/Specialist)で問われる。ノーコードでの予測活用を体感的に学べる。
## 主要トピック
- Prediction Builder・Next Best Action・Einstein Bots
- Einstein for Sales/Service・Einstein Discovery
## おすすめリソース
Trailhead「Einstein」、AI Associate試験ガイド`,
    links:[{to:'concept-ai',rel:'中核'},{to:'prod-agentforce',rel:'発展'}] },

  { id:'prod-tableau', label:'Tableau', type:'product', category:'analytics',
    summary:'全社横断のセルフサービスBI。豊富な可視化とAIインサイト(Pulse)。',
    tags:['analytics','bi','tableau'],
    detail:`## 概要
Salesforce傘下の汎用BIプラットフォーム。ドラッグ&ドロップの豊富な可視化、Tableau Prep(データ整形)、Tableau Pulse(AIインサイト)を提供し、Salesforce/Data Cloudと接続できる。
## なぜ学ぶのか
標準レポートを超えた全社横断の高度分析の需要が高い。CRM内蔵の CRM Analytics とは別製品で、選定判断ができる人材が重宝される。
## 主要トピック
- ワークブック・データソース・Tableau Prep
- Tableau Pulse・Salesforce/Data Cloud接続
## おすすめリソース
Trailhead「Tableau」`,
    links:[{to:'concept-analytics',rel:'中核'},{to:'role-data-analyst',rel:'対象職種'}] },

  { id:'prod-crm-analytics', label:'CRM Analytics', type:'product', category:'analytics',
    summary:'Salesforceネイティブの分析基盤(旧Tableau CRM)。大量データを対話的に。',
    tags:['analytics','crm-analytics'],
    detail:`## 概要
Salesforceに組み込まれた分析基盤(旧Tableau CRM/Einstein Analytics)。データセット・レンズ・ダッシュボードの3層構造、SAQL、Einstein Discoveryによる予測分析を提供する。汎用BIの Tableau とは別製品。
## なぜ学ぶのか
標準レポートの限界(集計規模・複数オブジェクト横断)を超えた分析を、CRMのセキュリティ内で実現できる。
## 主要トピック
- データセット・レンズ・ダッシュボード・SAQL
- レシピ(Data Prep)・Einstein Discovery
## おすすめリソース
Trailhead「CRM Analytics」`,
    links:[{to:'concept-analytics',rel:'中核'},{to:'role-data-analyst',rel:'対象職種'},{to:'prod-tableau',rel:'関連'}] },
...
Trailhead「Field Service」、Field Service Consultant試験ガイド`,
  ...
  { id:'prod-revenue-cloud', label:'Revenue Cloud', type:'product', category:'cloud',
    summary:'見積〜契約〜請求〜収益認識まで収益ライフサイクル全体を管理。',
    tags:['revenue','billing'],
    detail:`## 概要
見積-現金化(Quote to Cash)の全体像から、契約・注文・請求(Billing)・収益認識までの収益ライフサイクルを管理するクラウド。製品構成・価格の中核である CPQ を含む上位の製品ファミリー。
## なぜ学ぶのか
見積と請求のデータ断絶を解消し、サブスク/従量課金の収益管理を一気通貫にできる。会計・ERP連携の要。
## 主要トピック
- 見積-現金化(Quote to Cash)の全体像
- 請求(Billing)・収益認識・サブスクリプション更新
## おすすめリソース
Trailhead「Revenue Cloud」「Salesforce Billing」`,
    links:[{to:'prod-sales-cloud',rel:'拡張'},{to:'prod-cpq',rel:'内包'}] },

  { id:'prod-cpq', label:'Salesforce CPQ', type:'product', category:'cloud',
    summary:'複雑な製品構成・価格・見積を正確かつ高速に作る構成価格見積ツール。',
    tags:['cpq','pricing'],
    detail:`## 概要
Configure Price Quote。製品バンドル・選択ルール・価格ルール・割引スケジュールにより、「正しい構成の見積しか作れない」状態を実現する。Revenue Cloud の中核だが、CPQ 単体の製品(旧Steelbrick)として広く導入されている。
## なぜ学ぶのか
複雑な価格体系を持つ企業で導入が進み、CPQスペシャリストは高単価。
## 主要トピック
- 製品バンドルと選択ルール・価格ルール
- 割引スケジュール・サブスクリプションと更新
## おすすめリソース
Trailhead「Salesforce CPQ」、CPQ Specialist試験ガイド`,
    links:[{to:'prod-sales-cloud',rel:'拡張'},{to:'prod-revenue-cloud',rel:'一部'},{to:'cert-cpq-specialist',rel:'関連資格'}] },

  { id:'prod-industries', label:'Industry Clouds (業種クラウド)', type:'product', category:'cloud',
    summary:'金融・医療・公共など業種別に最適化された業種特化クラウド群。',
    tags:['industries'],
    detail:`## 概要
金融(FSC)・通信・公共(PSS)・ヘルスケアなど、業種別のデータモデルとプロセスをテンプレート化した業種特化クラウド群の総称。業種標準のエンティティを標準オブジェクトとして提供する。
## なぜ学ぶのか
業種特化の大型案件が増加。業種データモデルの理解が導入品質を左右する。UI構築ツールの OmniStudio とは別物として区別する。
## 主要トピック
- 業種データモデルとコアの使い分け
- FSC/Health/Manufacturing/Public Sector 等
## おすすめリソース
Trailhead「Industry Clouds」、各業種の実装ガイド`,
    links:[{to:'prod-platform',rel:'基盤'},{to:'prod-omnistudio',rel:'活用'}] },

  { id:'prod-omnistudio', label:'OmniStudio', type:'product', category:'cloud',
    summary:'ローコードでガイド付きUI・データ連携を構築するツールセット。',
    tags:['omnistudio','lowcode'],
    detail:`## 概要
OmniScript(ガイド付きフロー)・FlexCard(カード型UI)・DataRaptor(データマッピング)・Integration Procedure(サーバー側編成)・Calculation Procedure(計算)からなるローコード開発ツールセット。業種クラウドの標準プロセスの多くがこれで提供される。
## なぜ学ぶのか
業種クラウドのカスタマイズに必須で、OmniStudio開発者の需要が高い。業種クラウド(製品群)とは別のツール製品として区別する。
## 主要トピック
- OmniScript・FlexCard・DataRaptor
- Integration Procedure・Calculation Procedure
## おすすめリソース
Trailhead「OmniStudio」、OmniStudio Developer試験ガイド`,
    links:[{to:'prod-platform',rel:'基盤'},{to:'prod-industries',rel:'活用先'},{to:'cert-omnistudio-developer',rel:'関連資格'}] },
...
## 前提
LWC/Apex基礎の理解。`,
    links:[{to:'prod-omnistudio',rel:'領域'},{to:'role-developer',rel:'対象職種'}] },
...
バンドル、価格ルール、割引、見積テンプレート、契約更新の設計を問う。`,
    links:[{to:'prod-cpq',rel:'領域'},{to:'role-consultant',rel:'対象職種'}] },
...
プロスペクト、エンゲージメントスタジオ、スコアリング/グレーディング、フォーム、レポートを問う。`,
    links:[{to:'cert-pardot-consultant',rel:'次のステップ'},{to:'prod-account-engagement',rel:'領域'}] },
...
アカウント設計、Salesforce連携、リードマネジメント戦略を問う。`,
    links:[{to:'prod-account-engagement',rel:'領域'},{to:'role-marketer',rel:'対象職種'}] },
