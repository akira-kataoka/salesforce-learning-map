...
- **461 ノード / 2214 リンク** — 製品 (27)・職種 (11)・認定資格 (35)・概念 (14)・学習トピック (374)
- **製品・職種・認定資格・概念はすべて「グループ」**、トピックはそのグループに含まれる**最小単位**。1つのトピックは複数のグループ(製品 × 資格 × 概念 × 職種)に同時所属します。包含リンクはグループ色で描画。
- 製品は「/」で束ねず個別ノードに分割（Marketing Cloud と Account Engagement、Tableau と CRM Analytics、Agentforce と Einstein、Industry Clouds と OmniStudio、Revenue Cloud と CPQ）
